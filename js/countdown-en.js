...
function () { var a = u(this), b = a.length; if (!b) return ""; 1 < b && (a[b - 1] = "" + a[b - 1]); return a.join("") }; n.prototype.toHTML = function (a) { a = a || "span"; var b = u(this), c = b.length; if (!c) return ""; for (var d = 0; d < c; d++) b[d] = "\x3c" + a + "\x3e" + b[d] + "\x3c/" + a + "\x3e"; --c && (b[c] = "" + b[c]); return b.join("") }; u = function (a) {
...
b.push(f(c, 4)); (c = a.hours); b.push(f(c, 3)); (c = a.minutes); b.push(f(("0" + c).slice(-2), 2)); (c = a.seconds); b.push(f(("0" + c).slice(-2), 1)); (c = a.milliseconds) && b.push(f(c, 0)); return b
